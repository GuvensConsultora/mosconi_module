...
class Producttemplate(models.Model):
    ...
    cantidad_puertas = fields.Integer(string="Cantidad de Puertas")
    ...
    cantidad_cajones = fields.Integer(string="Cantidad de Cajones")
    ...
    cantidad_estantes_fijos = fields.Integer(string="Cantidad Estantes Fijos")
    ...
    cantidad_estantes_flotantes = fields.Integer(string="Cantidad Estantes Flotantes")
    ...
    cant_ruedas = fields.Integer(string="Cantidad de Ruedas")
